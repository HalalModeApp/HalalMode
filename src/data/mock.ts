...
export const MOCK_PREFERENCES: PrivatePreferences = {
  ...
  desiredFamilyGoals: ['wants_children_soon', 'wants_children_later'],
  preferredSects: [],
  // Nothing absolute by default: every criterion grades until a member says
  // otherwise, which is the whole point of the must-have model.
  mustHave: {},
  ownHeightCm: 182,
  ownWeightKg: 78,
  ownBuild: 'Fit / Active',
